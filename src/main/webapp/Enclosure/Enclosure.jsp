...
<body>
	...
	<div class="container">
		<h1>ADD Enclosure Data</h1>
		<form id="insertForm" action="EnclosureAction.jsp" target="_top">
			<label for="type">Enclosure Type</label>
			<input type="text" name="type" required>
			<label for="location">Enclosure Location</label>
