...
<body>
	...
	<div class="container">
		...
		<form id="insertForm" action="AnimalAction.jsp" target="_top">
			...
			<label for="year">Arrive Year</label>
			<input type="number" name="year" required>
			<label for="kID">Keeper ID</label>
			<input type="number" name="kID" required>
			<label for="eID">Enclosure ID</label>
			<input type="number" name="eID" required>
			<label for="dID">Diet ID</label>
			<input type="number" name="dID" required>
			<label for="sID">Species ID</label>
